...
function clean(){
  rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/peer/msp/cacerts/ca.crt.tpl
  rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/peer/msp/signcerts/agent.crt.tpl
  rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/peer/msp/keystore/agent.key.tpl

  # rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/peer/tls/ca.crt.tpl
  # rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/peer/tls/agent.crt.tpl
  # rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/peer/tls/agent.key.tpl

  rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/admin/msp/cacerts/ca.crt.tpl
  rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/admin/msp/signcerts/agent.crt.tpl
  rm /home/taipan/workspace/ccllp/fabric-ca-net/network/certs/peerorg/admin/msp/keystore/agent.key.tpl
}
